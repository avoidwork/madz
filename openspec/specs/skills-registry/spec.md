...
#### Scenario: Frontmatter name matching directory name registers without warning

- **WHEN** a `SKILL.md` frontmatter `name` matches the directory name
- **THEN** the registry registers the skill under the directory name with no name-drift warning

#### Scenario: Frontmatter name drifting from directory name emits a warning

- **WHEN** a `SKILL.md` frontmatter `name` differs from the directory name
- **THEN** the registry registers the skill under the directory name as the canonical identifier and emits a warning that the frontmatter name drifts from the directory name
