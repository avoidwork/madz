...
- **WHEN** the harness starts, no conversation file exists, and no profile exists at `memory/context/profile.md`
...
- **WHEN** the harness starts and a valid profile exists at `memory/context/profile.md`
