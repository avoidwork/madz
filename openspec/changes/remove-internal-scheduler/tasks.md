...
- [ ] 1.6 Update `src/scheduler/index.js` exports
...
- [ ] 3.1 Remove `#tickId` field from ScheduleManager class
- [ ] 3.2 Remove `start()` method from ScheduleManager class
- [ ] 3.3 Remove `stop()` method from ScheduleManager class
- [ ] 3.4 Remove `#clockTick()` method from ScheduleManager class
- [ ] 3.5 Remove imports of `matchesCron`, `ScheduleQueue`, `runScheduledSkill`, `logScheduleResult` from `scheduler.js`

## 4. Remove supporting modules

- [ ] 4.1 Remove `src/scheduler/queue.js`
- [ ] 4.2 Remove `src/scheduler/runner.js`
- [ ] 4.3 Remove `src/scheduler/logger.js`
- [ ] 4.4 Remove `src/scheduler/matcher.js`
- [ ] 4.5 Remove `src/scheduler/parser.js`

## 5. Update scheduler index exports

- [ ] 5.1 Remove exports of ScheduleQueue from `src/scheduler/index.js`
- [ ] 5.2 Remove imports of queue, runner, logger, matcher, parser from `src/scheduler/index.js`
- [ ] 5.3 Rename CronInstaller export to Cron in `src/scheduler/index.js`
