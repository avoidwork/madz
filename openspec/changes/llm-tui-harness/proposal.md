...
- A set of standalone built-in tools covering local and remote environment interaction (filesystem, shell, SSH, Git, process management, network, package management, cloud APIs, database, webhooks)
...
- `tools-standalone`: Comprehensive set of built-in tools for local and remote environment interaction (filesystem, shell, SSH, Git, process management, network, package management, cloud APIs, database, webhooks, clipboard)
