...
|------|--------|------------------|-----------------|--------|
| message | yes | message | message | Append content to last message segment |
| message | maybe | reasoning | message | Append to last message segment if it exists and doesn't end with sentence-ending punctuation (`.`, `!`, `?`); otherwise push a new message segment (new block) |
| message | no | (none) | message | Push new message segment (first block) |
|      |        |                  |                 |        |
