...
flowchart TD
    ...
    LC -->|"dispatch"| DP["dispatchProvider()"]
    DP -->|"Provider → Agent → ReAct"| AG["Agent"]
...
flowchart TD
    ...
    RP -->|"enforce"| EC["enforceCapabilities()"]
    EC -->|"spawn"| SB["runSandbox()"]
    SB -->|"resolvePath / filterUrl / filterEnv"| RS["resource checks"]
