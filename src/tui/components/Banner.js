/**
 * Banner — BBS-style ASCII art startup banner with command help.
 * Dismisses on any key press (Escape exits the app).
 */
 ...
 * @param {string} [props.version] - Optional version string
 */
