/**
 * InputPanel — Display-only input panel with IRC-style prompt and blinking cursor.
 * All input handling is handled by App's single useInput hook.
 */
 ...
 * @param {string} [props.cursorColor] - Cursor text color
