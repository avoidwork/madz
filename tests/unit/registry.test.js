...
function validateSkillSchema(skill) {
  ...
  if (skill.inputSchema && (typeof skill.inputSchema !== "object" || Array.isArray(skill.inputSchema))) {
    errors.push(`Skill "${skill.name}" input schema must be an object`);
  }
  if (skill.outputSchema && (typeof skill.outputSchema !== "object" || Array.isArray(skill.outputSchema))) {
