...
describe("GraphProvider", () => {
	...
	test("should throw when clientId is missing", () => {
		assert.throws(
			() => new GraphProvider({ clientSecret: "secret", refreshToken: "token" }),
			/clientId/,
		);
	});
	...
	test("should throw when clientSecret is missing", () => {
		assert.throws(
			() => new GraphProvider({ clientId: "id", refreshToken: "token" }),
			/clientSecret/,
		);
	});
	...
	test("should throw when refreshToken is missing", () => {
		assert.throws(
			() => new GraphProvider({ clientId: "id", clientSecret: "secret" }),
			/refreshToken/,
		);
	});
